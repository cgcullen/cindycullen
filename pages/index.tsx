      ...
      <div className="bg-white">
        <div className="relative overflow-hidden">
          ...
          <main>
                    ...
                    {features.map((feature) => (
                      <div key={feature.name} className="pt-6">
                        <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                          <div className="-mt-6">
                            <div>
                              <span className="inline-flex items-center justify-center p-3 bg-gradient-to-r from-blue-500 to-green-600 rounded-md shadow-lg">
                                <feature.icon
            ...
            {/* Testimonial section */}
            <div className="pb-16 bg-gradient-to-r from-blue-500 to-green-600 lg:pb-0 lg:z-10 lg:relative">
            ...
            <div className="relative bg-gray-900">
              <div className="relative h-56 bg-blue-600 sm:h-72 md:absolute md:left-0 md:h-full md:w-1/2">
                ...
                <div
                  aria-hidden="true"
                  className="absolute inset-0 bg-gradient-to-r from-blue-500 to-green-600 mix-blend-multiply"
                />
              </div>
